...
//	dLamda=0;
	...
	//GeometryAlgorithm::DeformationLocalRefine(OldMesh,Mesh,OldHandlePos,NewHandlePos,this->dSquaredDistanceThreshold,
	...
	//std::ofstream outLR("result.obj",ios_base::out | ios_base::trunc);
