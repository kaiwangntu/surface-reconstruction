...
public:
	...
	static void LearnMatFromSrc(int iType,KW_Mesh& Mesh,vector<CString> vecTmpName);

	//export and import material
	static void ExportMat(KW_Mesh& Mesh,CString MatFileName);
	static void ImportMat(KW_Mesh& Mesh,CString MatFileName);
