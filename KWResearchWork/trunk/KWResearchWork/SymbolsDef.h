...
const GLfloat OPAQUE_CROSS_SECTION_COLOR[] = {1.0f, 0.84f, 0.0f, 1.0f};//{1.0f, 1.0f, 0.0f, 1.0f};
...
#define CREATION_SKETCH_CURVE_NAME_END 2199
#define CREATION_COMPUTE_CURVE_NAME_BEGIN 2200
#define CREATION_COMPUTE_CURVE_NAME_END 2299
#define CREATION_CURVE_NAME_BEGIN 2000
#define CREATION_CURVE_NAME_END 2299
...
const int CR_RENDER_ALL_SINGLE_CYLINDER=99999; 
const int CR_RENDER_NONE_SINGLE_CYLINDER=-1; 
const int CR_RENDER_ALL_UNION_CYLINDER=99999; 
const int CR_RENDER_NONE_UNION_CYLINDER=-1; 
//render subspace in our progressive surface reconstruction algorithm
const int CR_RENDER_ALL_SS=99999; 
const int CR_RENDER_NONE_SS=-1; 

//topology join/split in mesh creation
const int CR_TOPO_JOIN=1;
const int CR_TOPO_SPLIT=2;
