...
typedef Eekernel::Point_3 EePoint_3;
typedef Eekernel::Point_2 EePoint_2;
typedef Eekernel::Line_2 EeLine_2;
typedef Eekernel::Ray_3 EeRay_3;
typedef Eekernel::Direction_3 EeDirection_3;
...
typedef std::vector<EePolygon_with_holes_2>                   EePwh_vector_2;
typedef EePolygon_2::Vertex_iterator EeVertex_iterator_2;
typedef EePolygon_with_holes_2::Hole_const_iterator EeHole_const_iterator_2;
...
public:
	...
	//functions used in mesh creation only
	Point_3 GetExtruCenter() {return this->ExtruCenter;}
	void SetExtruCenter(Point_3 PointIn) {this->ExtruCenter=PointIn;}

	int GetReserved(){return this->iReserved;};
	void SetReserved(int iInput) {this->iReserved=iInput;}
...
protected:
	...
	//variables used in mesh creation only
	//center of extruded face of cylinder
	Point_3 ExtruCenter;
	//reserved
	int iReserved;
...
/*for faster computation of intersections using AABB tree*/
