...
public:
	...
	//reset the initial planes
	void ResetDrawingPlane();
	//rotate drawing plane
	//0: Axis: Midpoints of bounding points 01->23, Angle: +
	//1: Axis: Midpoints of bounding points 01->23, Angle: -
	//2: Axis: Midpoints of bounding points 12->30, Angle: +
	//3: Axis: Midpoints of bounding points 12->30, Angle: -
	void RotateDrawingPlane(int iRotOpt);
	//translate drawing plane
	//0: along the plane normal
	//1: along the opposite plane normal
	void TranslateDrawingPlane(int iTransOpt);
	//compute the intersected curves of the plane and mesh,
	//done after plane translation/rotation
	void StopTransformDrawingPlane();
	...
	//for sketching cross sections
	void Convert2DProfileTo3D();
	//for sketch-assisted topology editing
	void Input2DProfilePointTopoEdit(CPoint ProfilePoint);
	void Convert2DProfileTo3DTopoEdit(int iType,KW_Mesh& Mesh,vector<double> vecMeshColor);
