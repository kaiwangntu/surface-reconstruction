...
namespace
{
  ...
  void converge (POINT3* p1, POINT3* p2, float v, 
								 ImplicitFunction* function, POINT3* p)
  {
    int i = 0;
    POINT3 pos, neg;
    if (v < 0) {
  ...
  void vnormal (ImplicitFunction* function, POINT3* point, POINT3* n, float delta)
  {
  ...
  {	   /* parameters, function, storage */
    ...
    POINT3 start;		   /* start point on surface */
